...
const Color = ({ color }) => {
  const apiColors = document.querySelectorAll('.color');
  ...
  apiColors.forEach((color) => {
    color.addEventListener('click', () => {
      ...
      try {
        ...
        const original = color.innerText;
  ...
  return (
    <div
      className="color m-3 box-border w-3/4 md:w-1/3 p-4 border-4 flex flex-col shadow-md hover:shadow-2xl cursor-pointer"
